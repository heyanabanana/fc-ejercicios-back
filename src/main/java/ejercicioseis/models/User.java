package ejercicioseis.models;

import ejercicioseis.util.Hash;
import ejercicioseis.util.Validation;
...
public class User {
    ...
    //REGISTRO
    public static User registerService(String fullname, String email, String password) {
        String hashPassword = Hash.HashPassword(password);
        return new User(fullname, email, hashPassword);
    }
